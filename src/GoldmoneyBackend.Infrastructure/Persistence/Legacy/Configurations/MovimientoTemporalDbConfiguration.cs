...
public sealed class MovimientoTemporalDbConfiguration : IEntityTypeConfiguration<MovimientoTemporalDb>
{
    public void Configure(EntityTypeBuilder<MovimientoTemporalDb> builder)
    {
        builder.ToTable("MOVIMIENTO_TEMPORAL");
        ...
        builder.HasOne<EmpresaDb>()
            ...
            .HasConstraintName("FK_MOVIMIENTO_TEMPORAL_EMPRESA");
    }
}